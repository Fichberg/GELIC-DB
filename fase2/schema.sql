...
create table administradores(
  email varchar(254) primary key references membros(email) 
);
...
alter table membros add email_admin varchar(254) references administradores(email);
...
create table midias(
  ...
  email_admin varchar(254) not null references administradores(email),
...
create table estados(
  nome varchar(50),
  nome_pais varchar(50) references paises,
...
create table cidades(
  ...
  constraint cidades_estados_fk foreign key (nome_estado, nome_pais) references estados (nome, nome_pais)
);
...
create table transcricoes(
  ...
  constraint transcricoes_cidades_fk foreign key (nome_cidade, nome_pais) references cidades (nome, nome_pais)
);
...
create table membro_fez_transcricao(
  email_membro varchar(254) references membros,
